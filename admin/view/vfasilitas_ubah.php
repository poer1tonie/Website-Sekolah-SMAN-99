  ...
  <div class="card recent-sales overflow-auto">
    <div class="card-body">
      ...
      <form class="form-horizontal" action="./index.php?aksi=Master&xaksi=fasilitas&yaksi=6" method="post" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
          <label for="nm_fasilitas" class="col-sm-2 col-form-label">Nam fasilitas</label>
          <div class="col-sm-10">
            <input type="text" class="form-control"  value="<?php echo $row['nm_fasilitas']; ?>" name="nm_fasilitas" id="nm_fasilitas">
          </div>
        </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" value="<?php echo $row['keterangan']; ?>" id="keterangan" name="keterangan">
          </div>
        </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <img src="../images/fasilitas/<?php echo $row['gambar']; ?>" alt="Slide Image" width="200">
